...
public class AI {
	...
	static String[] features = { "RTID", "RTU", "TID", "TSUM", "UFRN", "THTG", "TURL", "UFLW", "UID", "NEG", "POS",
			"POS_NEG", "NUM_NODES", "NUM_EDGES", "NUM_CMP", "MAX_DIST" };
...
//			System.out.println("Feature : " + features[i]);
			...
			// System.out.println("Number of Companies Greater than " + threshold + " : " + cnt1);
			// System.out.println("Average Company Sum Greater than " + threshold + " : " + cnt2);
	...
	private Company[][] readData() throws BiffException, IOException {
		File statusDir = new File("/media/MyData/DropBox/Dropbox/Stock Market Daily Data/statistics/plain");
