...
public class GephiScript {
	...
	public void script() {
		...
		degreeFilter.setRange(new Range(30, Integer.MAX_VALUE)); // Remove nodes
																	// with
																	// degree <
																	// 30
		Query query = filterController.createQuery(degreeFilter);
		GraphView view = filterController.filter(query);
		graphModel.setVisibleView(view); // Set the filter result as the visible
											// view
